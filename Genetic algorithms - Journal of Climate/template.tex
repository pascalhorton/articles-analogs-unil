...
\authors{Pascal Horton\correspondingauthor{Pascal Horton, Terranum, Rue de l'industrie 35 bis, 1030 Bussigny, Switzerland.}\thanks{Current affiliation: Terranum, Bussigny, Switzerland}}
...
\begin{equation}
[p_{i,j}, h_{i,j}, xw_{i,j}, xe_{i,j}, ys_{i,j}, yn_{i,j}, p_{i,j+1}, h_{i,j+1}, ..., n_{i}, ... p_{i+1,j}, h_{i+1,j}, ..., n_{i+1}, ...]
\end{equation}
where, for the level of analogy $i$ and the predictor number $j$, $p_{i,j}$ is the pressure level, $h_{i,j}$ is the hour of the day, $xw_{i,j}$ and $xe_{i,j}$ are the western and eastern longitudes of the spatial window, $ys_{i,j}$ and $yn_{i,j}$ are its southerly and northerly latitudes, and $n_{i,j}$ is the number of analogues. A chromosome for the simple AM on the circulation (Sect. \ref{sec:am}) only may be: $[500~hPa, 12~h, -2.5\degree, 15\degree, 40\degree, 55\degree, 1000~hPa, 24~h, 0\degree, 15\degree, 42.5\degree, 47.5\degree, 28]$
...
\begin{figure}[t]
	\begin{center}
		\noindent\includegraphics[width=19pc,angle=0]{figures/operator_selectcoupl_score.pdf}\\
	\end{center}
...
\begin{figure*}[t]
	\begin{center}
		\noindent\includegraphics[width=39pc,angle=0]{figures/operator_crossover_score.pdf}\\
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\noindent\includegraphics[width=19pc,angle=0]{figures/operator_mutation_score.pdf}\\
	\end{center}
...
\begin{figure*}[t]
	\begin{center}
		\noindent\includegraphics[width=33pc,angle=0]{figures/operator_mutation_score_atmlevel.pdf}\\
	\end{center}
...
\begin{figure*}[t]
	\begin{center}
		\noindent\includegraphics[width=33pc,angle=0]{figures/operator_mutation_score_rhoneamont.pdf}\\
	\end{center}
...
\begin{figure*}[t]
	\begin{center}
		\noindent\includegraphics[width=33pc,angle=0]{figures/operator_mutation_score_r2.pdf}\\
	\end{center}
...
\begin{figure*}[t]
	\begin{center}
		\noindent\includegraphics[width=33pc,angle=0]{figures/operator_mutation_score_r4.pdf}\\
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\noindent\includegraphics[width=11pc,angle=0]{figures/operator_selectnat_score.pdf}\\
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\noindent\includegraphics[width=11pc,angle=0]{figures/option_taillepop_score.pdf}\\
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\noindent\includegraphics[width=11pc,angle=0]{figures/option_popratio_score.pdf}\\
	\end{center}
