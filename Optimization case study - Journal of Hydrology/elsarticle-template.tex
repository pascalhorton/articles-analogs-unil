...
\begin{figure}[t]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_map.pdf}}
...
\begin{figure}[t]
	\centerline{\includegraphics[width=8.4cm]{figures/figure_spatial_win_z4.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_dcrpss_4Zo.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_dcrps_comp_4Zo.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.4cm]{figures/table_crossing_z4_calib.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.4cm]{figures/table_crossing_z4_valid.pdf}}
	\caption{Same as Figure \ref{fig:crossing_4Zo_calib} but for the validation period.}
	\label{fig:crossing_4Zo_valid}
\end{figure}

\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_spatial_win_z4-hi2.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_dcrpss_4Zo-2HIo.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_dcrpss_4Zo-4HIo.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_dcrps_comp_4Zo-2HIo.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_nb_analogues.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_nb_analogues_relationships.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.4cm]{figures/table_crossing_z4-hi2_calib.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.4cm]{figures/table_crossing_z4-hi2_valid.pdf}}
	\caption{Same as Figure \ref{fig:crossing_4Zo-2MIo_calib} but for the validation period.}
	\label{fig:crossing_4Zo-2MIo_valid}
\end{figure}

\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_levels_weights.pdf}}
	\caption{Optimized weighting for the pressure levels of the 4Zo method.}
	\label{fig:levels_weights}
\end{figure}

\begin{figure}[htb]
	\centerline{\includegraphics[width=8.8cm]{figures/figure_levels_weights_average.pdf}}
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=7.5cm]{figures/figure_evolution.pdf}}
