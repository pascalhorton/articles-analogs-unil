...
\begin{document}
	...
	Synoptic-scale variables, used as predictors, were extracted from the ERA-20C reanalysis dataset \citep{Poli2016} with a 3h temporal resolution, and a spatial resolution of 1\textdegree. The study was originally performed on the NCEP/NCAR reanalysis 1 dataset \citep{Kalnay1996}, and the conclusions were similar. The main advantage of the ERA-20C is that it allows testing the relevance of the MTW at a 3h time step.
	...
	\begin{figure}[htb]
		\begin{center}
			\includegraphics[width=8.2cm]{fig06.pdf}
		\end{center}
	...
	\begin{figure}[htb]
		\begin{center}
			\includegraphics[width=8.1cm]{fig09.pdf}
		\end{center}
