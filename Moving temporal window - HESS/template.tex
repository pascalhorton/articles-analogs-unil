...
\begin{document}
	...
	\begin{abstract}
		...
		The improvements of the analogy criterion and the performance scores on precipitation were both found to be higher for MTWs with a smaller time step  of 3 h. A 3-h MTW provides eight times more candidate situations even though they are not fully independent. Because the MTW provides additional situations to the pool of possible analogues, it can be considered as an inflation of the meteorological archive. Because this technique is very simple and easily applicable, it should be considered for several applications in different contexts, such as operational forecasting or climate-related studies.
