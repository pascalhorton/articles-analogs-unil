...
\begin{document}
	...
	\begin{figure*}[htb]
		...
		\end{center}
		\caption{Reliability diagrams for the (a, c, e) 2Z method and (b, d, f) the 2Z-2MI method and the prediction of the exceedence of percentiles (a, b) 80~\%, (c, d) 90~\% and (e, f) 95~\% at the Ulrichen station. The percentiles were processed on the whole period and the plots were established on the VP only. The conventional method (24h) is provided as well as the 12h-MTW, 6h-MTW and 3h-MTW.}
		\label{fig:reliability_diagrams}
	\end{figure*}

	\begin{figure}[htb]
		\includegraphics[width=7.5cm]{fig13.pdf}
