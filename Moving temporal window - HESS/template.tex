...
\begin{figure*}[h]
	\begin{center}$
		\begin{array}{cccc}
		\includegraphics[width=4cm]{figures/Graphique_fenetre_glissante_comp_R1_justesse.pdf} &
		\includegraphics[width=4cm]{figures/Graphique_fenetre_glissante_comp_R1_finesse.pdf} &
		\includegraphics[width=4cm]{figures/Graphique_fenetre_glissante_comp_R2_justesse.pdf} &
		\includegraphics[width=4cm]{figures/Graphique_fenetre_glissante_comp_R2_finesse.pdf} \\
		\includegraphics[width=4cm]{figures/Graphique_fenetre_glissante_comp_R1_justesse_recalib.pdf} &
		\includegraphics[width=4cm]{figures/Graphique_fenetre_glissante_comp_R1_finesse_recalib.pdf} &
		\includegraphics[width=4cm]{figures/Graphique_fenetre_glissante_comp_R2_justesse_recalib.pdf} &
