...
Another potential application of the STW is when the time step of interest is multi-daily, such as a precipitation total over 3 days. In this case, the daily predictors can be assessed in the same way it was here applied at a sub-daily time step, and long archives of daily precipitation totals can be used.
