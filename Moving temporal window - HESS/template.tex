...
\begin{figure}[htb]
	\begin{center}$
		\begin{array}{c}
		\includegraphics[width=8.3cm]{figures/Graphique_fenetre_glissante_chmts_S1_saisons_val.pdf} \\
		\includegraphics[width=6.5cm]{figures/Graphique_fenetre_glissante_chmts_S1_saisons_gain.pdf}
		\end{array}$
	\end{center}
