...
\citep{Horton2016} }%DIFAUXCMD
}\DIFdelend on the original archive (\DIFdelbegin \DIFdel{Tables \ref{table:params_2Z} and \ref{table:params_2Z-2MI}) and will be }\DIFdelend \DIFaddbegin \DIFadd{see resulting analogue numbers in Table \ref{table:analog_nb}) and were }\DIFaddend used thereafter.
...
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.3cm]{fig01.pdf}
	...
	\begin{figure}[htb]
		\begin{center}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.3cm]{figures/illustration_moving_window.pdf}
%DIFDELCMD < 	%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.3cm]{fig02.pdf}
	...
	\DIFaddend \begin{figure*}[htb]
		\begin{center}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=15cm]{figures/changes_S1_analogues.pdf}
%DIFDELCMD < 	%%%
...
\DIFdelendFL \DIFaddbeginFL \label{fig:changes_S1_analogs}
	...
	\begin{figure}[htb]
		\begin{center}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.2cm]{figures/changes_S1_value_and_gain.pdf}
%DIFDELCMD < 	%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.2cm]{fig07.pdf}
	...
	\begin{figure}[htb]
		\begin{center}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.3cm]{figures/changes_S1_precip_threshold.pdf}
%DIFDELCMD < 	%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.3cm]{fig08.pdf}
	...
	\begin{figure}[htb]
		\begin{center}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=7cm]{figures/changes_S1_seasons.pdf}
%DIFDELCMD < 	%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=7cm]{fig09.pdf}
	...
	\begin{figure}[htb]
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.3cm]{figures/hours_selection_per_season.pdf}
%DIFDELCMD < 	%%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < 	\includegraphics[width=8.3cm]{figures/hours_selection_per_season_Visp.pdf}
%DIFDELCMD < 	%%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
\DIFdelendFL \begin{center}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.1cm]{figures/changes_RMSE_value_and_gain.pdf}
%DIFDELCMD < 	%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.1cm]{fig10.pdf}
	...
	\begin{figure}[htb]
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=5cm]{figures/changes_CRPS_precip_threshold.pdf}
%DIFDELCMD < 	%%%
...
%DIFDELCMD < 		\includegraphics[width=8cm]{figures/illustration_disaggregation.pdf}
%DIFDELCMD < 	\end{center}
%DIFDELCMD < 	%%%
	...
	\begin{table}[htb]
		...
		\begin{center}
			\begin{tabular}{l c c c c c c }
				\hline
				\multirow{3}{*}{\DIFaddbeginFL \DIFaddFL{Station} \DIFaddendFL} & \multicolumn{3}{c}{\DIFaddbeginFL \DIFaddFL{Standard} \DIFaddendFL} & \multicolumn{3}{c}{\DIFaddbeginFL \DIFaddFL{MTW-r} \DIFaddendFL} \\
				& \DIFaddbeginFL \DIFaddFL{2Z} \DIFaddendFL & \multicolumn{2}{c}{\DIFaddbeginFL \DIFaddFL{2Z-2MI} \DIFaddendFL} & \DIFaddbeginFL \DIFaddFL{2Z} \DIFaddendFL & \multicolumn{2}{c}{\DIFaddbeginFL \DIFaddFL{2Z-2MI} \DIFaddendFL}\\
				& \DIFaddbeginFL \DIFaddFL{$N_{1}$} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{$N_{1}$} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{$N_{2}$} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{$N_{1}$} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{$N_{1}$} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{$N_{2}$} \DIFaddendFL\\ 
				\hline
				\DIFaddbeginFL \DIFaddFL{Ulrichen} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{40} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{60} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{25} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{50} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{110} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{35} \DIFaddendFL\\
				\DIFaddbeginFL \DIFaddFL{Zermatt} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{35} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{55} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{25} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{55} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{80} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{30} \DIFaddendFL\\
				\DIFaddbeginFL \DIFaddFL{Visp} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{30} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{45} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{25} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{55} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{135} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{35} \DIFaddendFL\\
				\DIFaddbeginFL \DIFaddFL{Montana} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{40} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{55} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{30} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{55} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{110} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{40} \DIFaddendFL\\
				\DIFaddbeginFL \DIFaddFL{Sion} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{40} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{90} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{30} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{55} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{140} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{50} \DIFaddendFL\\
				\DIFaddbeginFL \DIFaddFL{Aigle} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{50} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{100} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{35} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{75} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{135} \DIFaddendFL & \DIFaddbeginFL \DIFaddFL{45} \DIFaddendFL\\ 
				\hline
			\end{tabular}
		\end{center}
