...
AtmoSwing is developed under the Mercurial distributed revision control, and the source code can be found at:
...
The Forecaster and the Viewer are fully available, whereas the open version of the Optimizer includes all methods but the Genetic algorithms. These are planed to be released in the future, but not at the time of writing, due to lacking documentation and necessary return on investment made by Terranum.
