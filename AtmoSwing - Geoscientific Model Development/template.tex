...
The Forecaster and the Viewer are fully available, whereas the open version of the Optimizer includes all methods but the Genetic algorithms. These are planed to be released in the future, but not at the time of writing.
