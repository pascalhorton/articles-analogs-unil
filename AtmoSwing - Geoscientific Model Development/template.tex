...
The Optimizer integrates the most used technique, that is a semi-automatic sequential approach, as well as Monte-Carlo analyses, and especially a global optimization technique by means of Genetic algorithms. 
...
Due to the limitation of the sequential approach, we implemented a global optimization technique based on Genetic algorithms. This allows for a fully automatic and objective optimization of the AM. However, as this topic is rather consequent, it will be the subject of another publication.
