...
\subsection{References implementations for precipitation forecasting}
...
%\subsection{R0, les origines}
%\label{sec:etat_art:R0}

%Une référence préliminaire résulte des travaux de \citet{Guilbaud1997} et \citet{Obled2002}. Elle est constituée d'un seul niveau d'analogie sur la circulation atmosphérique considérée à 1000~hPa et 700~hPa (R0a, Table \ref{table:R0a}) ou 500~hPa (R0b, Table \ref{table:R0b}). Le critère S1 de Teweles-Wobus est alors utilisé pour comparer les champs de géopotentiel.
