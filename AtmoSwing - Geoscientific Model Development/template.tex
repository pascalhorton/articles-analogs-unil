...
He also assessed several variables for the second level of analogy and identified the moisture variables (precipitable water and relative humidity) and vertical velocity to be the most relevant. Finally, he found that the product of relative humidity and precipitable water gave the best performance.
...
\begin{table}[htbp]
	\caption{Variant of the PC-4Z method, by \citet{Guilbaud1997}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline 
...
The analogy on the atmospheric circulation (Table \ref{table:R1}) proposed by \citet{Bontron2004} is still, at the time of writing, often used, and considered as a reference for benchmarking new parameterizations. He noticed that the choice of the temporal window was more important than the atmospheric level. The method consists of the geopotential height on two atmospheric levels : 1000~hPa (Z1000) at 12~h and 500~hPa (Z700) at 24~h.
...
\citep{Bontron2004} then added a second level of analogy (Table \ref{table:R2}) on a moisture index : the product of relative humidity at 850~hPa (RH850) and total precipitable water (TPW). This index does not represent an actual physical quantity, but expresses the water content of the column and its proximity to saturation.

\begin{table}[htbp]
	\caption{Method of type PC-2Z-2HI proposed by \citet{Bontron2004}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline 
...
\citet{Marty2010} tested other temporal windows for intraday application on the basis of a more comprehensive reanalysis dataset. He first proposed to change the hours of observation for both levels of analogy (both for 06~h and 18~h), and selected the 925~hPa level for the moisture analogy (Table \ref{table:R3a}).




He proposed two models with a second level of analogy moisture (3a, Table \ ref {table: R3a}) or the moisture flux at ~ 700 hPa (3b, Table \ ref {table: 3b} ) or ~ 925 hPa (3c, Table \ ref {table: 3c}). The hours and levels change from those established by \ citet Bontron2004 {}, because they were not available then.
...
\begin{table}[htbp]
	\caption{Method of type PC-2Z-2HI proposed by \citet{Marty2010}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline 
...
Then, \citet{Marty2010} changed the humi

\begin{table}[htbp]
	\caption{Method of type PC-2Z-2HF proposed by \citet{Marty2010}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline 
...
\begin{table}[htbp]
	\caption{Method of type P2T-2Z-2HI proposed by \citet{BenDaoud2010}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline
...
\begin{table}[htbp]
	\caption{Method of type P2T-2Z-4HI proposed by \citet{BenDaoud2010}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline
...
\begin{table}[htbp]
	\caption{Method of type P2T-2Z-10HI proposed by \citet{BenDaoud2010}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline
...
\begin{table}[htbp]
	\caption{Method of type P2T-2Z-4W-2HI proposed by \citet{BenDaoud2010}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline
...
\begin{table}[htbp]
	\caption{Method of type P2T-2Z-4W-4HI proposed by \citet{BenDaoud2010}.}
	\begin{tabular}{ccccc}
		\tophline
		\textbf{Level} & \textbf{Variable} & \textbf{Hour} & \textbf{Criteria} & \textbf{Nb} \\ 
		\middlehline
...
\begin{table}[htbp]
	\caption{Method of type PC-4Zgo proposed by \citet{Horton2012}.}
	\begin{tabular}{ccccc}
...
\begin{table}[htbp]
	\caption{Method of type PC-4Zgo-2HIgo proposed by \citet{Horton2012}.}
	\begin{tabular}{ccccc}
