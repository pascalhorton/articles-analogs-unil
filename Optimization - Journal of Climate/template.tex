...
The resulting optimized parameters for z4 vary from one groupment to another. An example of the detailed parameters is provided for the Swiss Chablais in Table \ref{table:params_GA_z4}. The optimized spatial windows are given for every groupment in Figure \ref{fig:spatial_windows_z4}, and the selected atmospheric levels in Table \ref{table:levels_GA_z4}. The i
