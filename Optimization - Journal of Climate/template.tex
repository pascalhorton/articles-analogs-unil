...
\subsubsection{Results for the atmospheric circulation}
...
\subsubsection{Results for both analogy levels}
...
...
\begin{table}[htbp]
	\footnotesize
	\caption{Parameters of the z4-hi2 method (atmospheric circulation on 4 levels and humidity index on 2 levels), optimized for the Chablais region. The columns are the followings: L = level, V = variable, H = hour, D = domain, W = weight, C = criteria, N = number of analogues.}
	\begin{center}
		\begin{tabular}{ccccccc}
			\hline \textbf{L} & \textbf{V} & \textbf{H} & \textbf{D} & \textbf{W} & \textbf{C} & \textbf{N} \\ 
			\hline 
...
\begin{table}[htbp]
	\footnotesize
	\caption{Parameters of the z4-hi4 method (atmospheric circulation on 4 levels and humidity index on 4 levels), optimized for the Chablais region. The columns are the followings: L = level, V = variable, H = hour, D = domain, W = weight, C = criteria, N = number of analogues.}
	\begin{center}
		\begin{tabular}{ccccccc}
			\hline \textbf{L} & \textbf{V} & \textbf{H} & \textbf{D} & \textbf{W} & \textbf{C} & \textbf{N} \\ 
			\hline 
...
\begin{figure}[htb]
	\centerline{\includegraphics[width=8.3cm]{figures/figure_evolution.pdf}}
