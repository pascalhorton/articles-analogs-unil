...
Genetic Algorithms need however to be tailored to the addressed problem. Multiple combinations of algorithms were assessed, and new ones were developed (e.g. the \textit{chromosome of adaptive search radius} which was found to be very robust), in order to make recommendations for the use of Genetic Algorithms to optimize several variants of analog methods. A global optimization approach opens new perspectives for the improvement of analog methods, and their application to new regions or to new predictands.
}
