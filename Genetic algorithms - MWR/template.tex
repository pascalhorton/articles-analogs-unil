...
The document starts by presenting the case study area and the data (section \ref{sec:case_study_data}), the basics of the considered AM variants (section \ref{sec:am}), and the assessed GAs options (section \ref{sec:gas}). The comparative analyses of these options are presented in section \ref{sec:assessment}, which results in recommendations formulated in section \ref{sec:recommendations} and conclusions in section \ref{sec:conclusions}.
...
Even GAs configurations that will be considered later as inadequate, because they did not reach the global optimum (Fig. \ref{fig:gas_evolution_bad}), did significantly better that the sequential approach. GAs proved promising at optimizing AMs automatically, globally, and objectively.
...
Ref: 95\%   ( 0.2921,  0.3494 )  
Optimized: 95\%   ( 0.3521,  0.4011 )  
