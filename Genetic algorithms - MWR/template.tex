...
In the present study, the choice of the meteorological variables (predictors) is still performed manually. Then, for every level of analogy, GAs have to optimize jointly (i) the spatial windows (position and size; different between the pressure levels), (ii) the temporal windows (hours of observation of the predictors), (iii) the number of analog situations, and (iv) later on, the selection of the pressure levels (two, in this case). The first experiments are on a single level of analogy (on the geopotential height, see section \ref{sec:am}), and a second level (on moisture) is added further on in section \ref{sec:assessment}.\ref{sec:assessment:results}.\ref{sec:assessment:mutation}.
